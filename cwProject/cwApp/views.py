...
def index(request):
    return HttpResponse("Please go to the movies directory.")

def moviesFunc(request):
    return render(request,"cwApp/movies.html", {'movie_list':movies})

def movieDetails(request,movie_id):
    return render(request, 'cwApp/movie_details.html',{'movie_list':movies})

def movieSynopsis(request,movie_id):
    return render(request, 'cwApp/movie_synopsis.html',{'movie_list':movies})
